...
### Following the [roadmap.sh](https://roadmap.sh/frontend) Frontend Developer Path

![roadmap](https://img.shields.io/badge/roadmap.sh-Frontend-6366f1?style=for-the-badge)
...
This repository contains all frontend projects I am completing as part of the **roadmap.sh frontend development path**. Each project is built from scratch using only the fundamentals — no frameworks, no shortcuts.

The goal is simple: **learn by doing, ship real projects, grow every day.**
...
📁 [Updated version](./Basic%20HTML%20website) <br>| 🌐 [Project URL](https://roadmap.sh/projects/portfolio-website)
...
```bash
# Clone the repo
git clone https://github.com/israqxaman2/RoadMap-Front-End-Development.git

# Go into any project folder
cd RoadMap-Front-End-Development/single-page-cv
...
[![GitHub](https://img.shields.io/badge/GitHub-israqxaman2-181717?style=for-the-badge&logo=github)](https://github.com/israqxaman2)

---

<div align="center">

*Built with curiosity, consistency, and a lot of browser refreshes.* 💻
